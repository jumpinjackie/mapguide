...
template class MG_SERVICE_API Ptr<MgUpdateFeatures>;
...
class MG_SERVICE_API  MgUpdateFeatures : public MgFeatureCommand
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = FeatureService_UpdateFeatures;
