...
///
class MG_SERVICE_API MgDrawingService : public MgService
{
PUBLISHED_API:
    ///////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief
...
INTERNAL_API:
    ...
    ///
    MgDrawingService(MgConnectionProperties* connection);
...
CLASS_ID:
    static const INT32 m_cls_id = DrawingService_DrawingService;
};
/// \}
