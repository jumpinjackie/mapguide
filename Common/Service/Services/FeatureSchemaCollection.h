...
template class MG_SERVICE_API Ptr<MgFeatureSchemaCollection>;
...
///
class MG_SERVICE_API MgFeatureSchemaCollection : public MgCollection
{
...
CLASS_ID:
    static const INT32 m_cls_id = FeatureService_FeatureSchemaCollection;
};
/// \}
