...
template class MG_SERVICE_API Ptr<MgInsertFeatures>;
...
///
class MG_SERVICE_API  MgInsertFeatures : public MgFeatureCommand
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = FeatureService_InsertFeatures;
