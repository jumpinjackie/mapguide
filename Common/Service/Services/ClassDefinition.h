...
template class MG_SERVICE_API Ptr<MgClassDefinition>;

/////////////////////////////////////////////////////////////////
/// \brief
/// Defines a feature class belonging to a schema.
///
class MG_SERVICE_API MgClassDefinition : public MgNamedSerializable
{
...
CLASS_ID:
    static const INT32 m_cls_id = FeatureService_ClassDefinition;
};
/// \}
