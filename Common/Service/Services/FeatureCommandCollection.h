...
template class MG_SERVICE_API Ptr<MgFeatureCommandCollection>;
...
///
class MG_SERVICE_API  MgFeatureCommandCollection : public MgSerializable
{
...
CLASS_ID:
    static const INT32 m_cls_id = FeatureService_FeatureCommandCollection;
};
/// \}
