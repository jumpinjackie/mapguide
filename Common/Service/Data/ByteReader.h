...
class MgByteSource;
template class MG_SERVICE_API Ptr<MgByteSource>;

class MgByteReader;
template class MG_SERVICE_API Ptr<MgByteReader>;
...
class MG_SERVICE_API MgByteReader : public MgSerializable
{
...
CLASS_ID:
    static const INT32 m_cls_id = CoreData_Data_ByteReader;
};
/// \}
