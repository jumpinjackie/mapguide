...
template class MG_SERVICE_API Ptr<MgReadOnlyLayerCollection>;
...
///
class MG_SERVICE_API MgReadOnlyLayerCollection : public MgDisposable
{
...
CLASS_ID:
    static const INT32 m_cls_id = MapLayer_ReadOnlyLayerCollection;
