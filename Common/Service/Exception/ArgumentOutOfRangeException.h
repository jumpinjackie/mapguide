...
///
class MG_SERVICE_API MgArgumentOutOfRangeException : public MgOutOfRangeException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = Common_Exception_MgArgumentOutOfRangeException;
};
