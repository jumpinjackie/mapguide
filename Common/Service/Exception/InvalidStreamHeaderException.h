...
///
class MG_SERVICE_API MgInvalidStreamHeaderException : public MgStreamIoException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = Common_Exception_MgInvalidStreamHeaderException;
};
