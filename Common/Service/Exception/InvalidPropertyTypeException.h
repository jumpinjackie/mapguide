...
///
class MG_SERVICE_API MgInvalidPropertyTypeException : public MgSystemException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = Common_Exception_MgInvalidPropertyTypeException;
};
