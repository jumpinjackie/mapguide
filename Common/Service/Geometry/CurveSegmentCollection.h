...
template class MG_SERVICE_API Ptr<MgCurveSegmentCollection>;

///////////////////////////////////////////////////////////////////////////////
/// \brief
/// MgCurveSegmentCollection provides support for defining an ordered set of
/// curve segments.
class MG_SERVICE_API MgCurveSegmentCollection : public MgDisposable
{
...
PUBLISHED_API:
    ...
    /// <!-- Syntax in .Net, Java, and PHP -->
    /// \htmlinclude DotNetSyntaxTop.html
    /// virtual int Add(MgCurveSegment value);
    /// \htmlinclude SyntaxBottom.html
    /// \htmlinclude JavaSyntaxTop.html
    /// virtual int Add(MgCurveSegment value);
    /// \htmlinclude SyntaxBottom.html
    ...
    /// Index of the newly added curve segment.
    ///
    virtual INT32 Add(MgCurveSegment* value);
    ...
    /// <!-- Syntax in .Net, Java, and PHP -->
    /// \htmlinclude DotNetSyntaxTop.html
    /// virtual void Remove(const MgCurveSegment value);
    /// \htmlinclude SyntaxBottom.html
    /// \htmlinclude JavaSyntaxTop.html
    /// virtual void Remove(const MgCurveSegment value);
    /// \htmlinclude SyntaxBottom.html
