...
template class MG_SERVICE_API Ptr<MgCurveRingCollection>;

///////////////////////////////////////////////////////////////////////////////
/// \brief
/// MgCurveRingCollection provides support for defining an ordered set of
/// curve rings.
class MG_SERVICE_API MgCurveRingCollection : public MgDisposable
{
...
PUBLISHED_API:
    ...
    /// <!-- Syntax in .Net, Java, and PHP -->
    /// \htmlinclude DotNetSyntaxTop.html
    /// virtual int Add(MgCurveRing value);
    /// \htmlinclude SyntaxBottom.html
    /// \htmlinclude JavaSyntaxTop.html
    /// virtual int Add(MgCurveRing value);
    /// \htmlinclude SyntaxBottom.html
    ...
    /// Index of the newly added curve ring.
    ///
    virtual INT32 Add(MgCurveRing* value);
    ...
    /// <!-- Syntax in .Net, Java, and PHP -->
    /// \htmlinclude DotNetSyntaxTop.html
    /// virtual void Remove(const MgCurveRing value);
    /// \htmlinclude SyntaxBottom.html
    /// \htmlinclude JavaSyntaxTop.html
    /// virtual void Remove(const MgCurveRing value);
    /// \htmlinclude SyntaxBottom.html
