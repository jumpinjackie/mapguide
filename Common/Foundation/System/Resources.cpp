...
const STRING MgResources::ServerServiceName             = L"MapGuideServer2.0"; // Do not translate
const STRING MgResources::ServerServiceDisplayName      = L"MapGuide Server v2.0"; // Do not translate
...
const STRING MgResources::Warning                       = L"Warning";
