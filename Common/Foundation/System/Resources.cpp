...
const STRING MgResources::ServerServiceName             = L"MapGuideServer2.2"; // Do not translate
const STRING MgResources::ServerServiceDisplayName      = L"MapGuide Server v2.2"; // Do not translate
