...
class MDFPARSER_API FSDSAX2Parser : public DefaultHandler
{
    protected:
        ...
        void WriteDefinition(MdfStream& fd, FeatureSource* pFeatureSource, MdfModel::Version* version);
    ...
    public:
        ...
        void WriteToFile(std::string name, FeatureSource* pFeatureSource, MdfModel::Version* version);

        std::string SerializeToXML(FeatureSource* pFeatureSource, MdfModel::Version* version);
