...
class MDFPARSER_API SAX2Parser : public DefaultHandler
{
    public:
        ...
        std::string SerializeToXML(PrintLayoutElementDefinition* pleElement, MdfModel::Version* version);
        ...
        // Creates a clone of the given map/layer/symbol/print layout element definition.  The
        ...
        static PrintLayoutElementDefinition* CreateClone(PrintLayoutElementDefinition* pleDefinition);
