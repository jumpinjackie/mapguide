...
//
// $Id: simpleAdd.java,v 1.11 2005/06/21 21:56:12 sarette Exp $
//
...
class simpleAdd
{
	...
	try {
	    ...
	    docConfig.setGenerateName(true);
            openedContainer.putDocument(txn, "", document1,
					updateContext, docConfig);

            //Do it again for the second document
            openedContainer.putDocument(txn, "", document2,
					updateContext, docConfig);
