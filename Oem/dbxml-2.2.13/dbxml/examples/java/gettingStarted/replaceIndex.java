...
//
// $Id: replaceIndex.java,v 1.11 2005/06/21 21:56:12 sarette Exp $
//
...
class replaceIndex
{
    ...
    private static void replaceIndex( XmlManager mgr, XmlContainer container,
	...
	try {
	    ...
	    txn = theMgr.createTransaction();
            ...
            replaceIndex(theMgr, openedContainer, "", "product",
