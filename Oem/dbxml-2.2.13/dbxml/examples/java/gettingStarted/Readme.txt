...
#
# $Id: Readme.txt,v 1.13 2005/06/21 21:59:29 sarette Exp $
...
the jar{/debug} directory, depending on your configuration.
...
in dbxml/bin/{debug,release}.  For example:
...
2.  Set CLASSPATH to include db.jar, dbxml.jar and dbxmlexamples.jar
    ...
    set CLASSPATH=%CLASSPATH%;<path_to_distribution>/jar/debug/db.jar;
         <path_to_distribution>/jar/debug/dbxml.jar;
         <path_to_distribution>/jar/debug/dbxmlexamples.jar
...
the directory where you placed your database environment. For example:
    ...
    java dbxml.gettingStarted.simpleQuery -h dbEnvironment
