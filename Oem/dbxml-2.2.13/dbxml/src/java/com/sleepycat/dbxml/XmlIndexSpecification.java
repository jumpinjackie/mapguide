...
public class XmlIndexSpecification {
  ...
  protected XmlIndexSpecification() {
    this(0, false);
  }
  ...
  public void addIndex(String uri, String name, int type, int syntax) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_addIndex__SWIG_0(swigCPtr, uri, name, type, syntax);
  }

  public void addIndex(String uri, String name, String index) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_addIndex__SWIG_1(swigCPtr, uri, name, index);
  }

  public void deleteIndex(String uri, String name, int type, int syntax) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_deleteIndex__SWIG_0(swigCPtr, uri, name, type, syntax);
  }

  public void deleteIndex(String uri, String name, String index) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_deleteIndex__SWIG_1(swigCPtr, uri, name, index);
  }

  public void replaceIndex(String uri, String name, int type, int syntax) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_replaceIndex__SWIG_0(swigCPtr, uri, name, type, syntax);
  }

  public void replaceIndex(String uri, String name, String index) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_replaceIndex__SWIG_1(swigCPtr, uri, name, index);
  }

  public void addDefaultIndex(int type, int syntax) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_addDefaultIndex__SWIG_0(swigCPtr, type, syntax);
  }

  public void addDefaultIndex(String index) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_addDefaultIndex__SWIG_1(swigCPtr, index);
  }

  public void deleteDefaultIndex(int type, int syntax) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_deleteDefaultIndex__SWIG_0(swigCPtr, type, syntax);
  }

  public void deleteDefaultIndex(String index) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_deleteDefaultIndex__SWIG_1(swigCPtr, index);
  }

  public void replaceDefaultIndex(int type, int syntax) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_replaceDefaultIndex__SWIG_0(swigCPtr, type, syntax);
  }

  public void replaceDefaultIndex(String index) throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_replaceDefaultIndex__SWIG_1(swigCPtr, index);
  }

  public void reset() throws XmlException {
    dbxml_javaJNI.XmlIndexSpecification_reset(swigCPtr);
  }

  public XmlIndexDeclaration find(String uri, String name) throws XmlException { return dbxml_javaJNI.XmlIndexSpecification_find(swigCPtr, uri, name); }

  public XmlIndexDeclaration next() throws XmlException { return dbxml_javaJNI.XmlIndexSpecification_next(swigCPtr); }

  public String getDefaultIndex() throws XmlException {
    return dbxml_javaJNI.XmlIndexSpecification_getDefaultIndex(swigCPtr);
  }
