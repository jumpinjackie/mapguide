...
//
// $Id: XmlIndexSpecification.cpp,v 1.12 2005/08/16 13:29:32 jsnelson Exp $
//
...
static XmlValue::Type valueTypeFromSyntaxType(Syntax::Type stype)
{
	...
	case Syntax::ANY_URI: return XmlValue::ANY_URI;
	...
	case Syntax::NOTATION: return XmlValue::NOTATION;
	case Syntax::QNAME: return XmlValue::QNAME;
