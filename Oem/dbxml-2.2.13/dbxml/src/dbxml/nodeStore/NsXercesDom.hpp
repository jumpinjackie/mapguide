...
//
// $Id: NsXercesDom.hpp,v 1.31 2005/11/22 00:57:38 gmf Exp $
//
 ...
 *   which is typed.  Pathan and XQuery never ask for instances of
...
public:
	NsXDOMDocument(NsDocument *doc, nsNode_t *node) :
...
public:
	...
	virtual void setDocumentURI(const XMLCh* documentURI) {
		NsXDOMNotImplemented("setDocumentURI");
	}
...
class NsXDOMElement: public XNSQ DOMElement,
	...
	friend class NsXDOMFactory;
public:
	NsXDOMElement(NsDocument *doc, nsNode_t *node,
...
class NsXDOMText: public XNSQ DOMCDATASection, public NsDomText {
	friend class NsXDOMFactory;
public:
	NsXDOMText(NsDomElement *parent, int index, uint32_t type)
		: NsDomText(parent, index, type) {}
...
class NsXDOMComment: public XNSQ DOMComment, public NsDomText {
	friend class NsXDOMFactory;
public:
	NsXDOMComment(NsDomElement *parent, int index)
		: NsDomText(parent, index, NS_COMMENT) {}
...
class NsXDOMProcessingInstruction: public XNSQ DOMProcessingInstruction, public NsDomText {
	friend class NsXDOMFactory;
public:
	NsXDOMProcessingInstruction(NsDomElement *parent, int index)
		: NsDomText(parent, index, NS_PINST) {}
...
public:
	NsXDOMFactory(XNSQ MemoryManager *memManager)
		: _memManager(memManager), _emptyNodeList(0) {}
public:
	...
	XNSQ DOMDocument *getDocumentNode() const {
		return (NsXDOMDocument*)_domDocumentObj;
	}
