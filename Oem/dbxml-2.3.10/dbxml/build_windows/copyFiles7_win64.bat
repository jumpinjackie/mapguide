...
@ECHO OFF
SET INSTALL=..\..
SET XERCES_BUILD=%INSTALL%\xerces-c-src\Build\Win64\VC7.1
SET XQILLA_BUILD=%INSTALL%\xqilla\build\windows\vc7.1
SET XML_BUILD=%INSTALL%\dbxml\build_windows
SET DB_BUILD=%INSTALL%\db-4.5.20\build_windows


SET LIB_DEST=%INSTALL%\lib64
SET BIN_DEST=%INSTALL%\bin64
SET JAR_DEST=%INSTALL%\jar64
SET BIN_DEBUG_DEST=%INSTALL%\bin\debug64
