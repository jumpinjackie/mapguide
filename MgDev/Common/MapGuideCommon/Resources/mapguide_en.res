...
MgCoordinateSystemComputationFailedException          = The coordinate system computation failed. %1
MgCoordinateSystemConversionFailedException           = The coordinate system conversion failed. %1
...
MgCoordinateSystemMeasureFailedException              = The coordinate system measure failed. %1
MgCoordinateSystemTransformFailedException            = The coordinate system transform failed. %1
MgCoordinateSystemDatumShiftSetupException            = Could not initialize the datum transformation.
...
MgCoordinateSystemInternalException                   = The failure occured internally when calling a low level function.
...
MgCoordinateSystemDuplicateException                  = The system is a duplicate of an existing one.
...
MgCoordinateSystemConversionExtentException           = A point, a portion of a line segment or a portion of the region, is outside of the mathematical domain of the coordinate system.
MgCoordinateSystemConversionWarningException          = Geodetic transformation failure, a point, a portion of a line segment or a portion of the region, is outside of the useful range of the coordinate system.
MgCoordinateSystemDictionaryOpenFailedException       = Could not open the dictionary file.
MgCoordinateSystemDictionaryCloseFailedException      = Could not close the dictionary file.
MgCoordinateSystemDictionaryClosedException           = The dictionary file is closed.
MgCoordinateSystemDictionaryOpenForReadException      = The dictionary file is open in read mode.
...
MgInvalidCoordinateSystemTypeException                = The coordinate system type is invalid. %1
MgInvalidCoordinateSystemUnitsException               = The coordinate system units are invalid. %1
