...
class MDFPARSER_API SAX2Parser : public DefaultHandler
{
    ...
    public:
        ...
        void WriteToFile(std::string name,
                         ...
                         GridLayerDefinition* gLayer,
                         MdfModel::Version* version);
        void WriteToFile(std::string name, SymbolDefinition* pSymbol, MdfModel::Version* version);

        std::string SerializeToXML(MapDefinition* pMap, MdfModel::Version* version);
        std::string SerializeToXML(LayerDefinition* pLayer, MdfModel::Version* version);
        std::string SerializeToXML(SymbolDefinition* pSymbol, MdfModel::Version* version);
