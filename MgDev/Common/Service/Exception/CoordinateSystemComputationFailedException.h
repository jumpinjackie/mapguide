...
///
class MG_SERVICE_API MgCoordinateSystemComputationFailedException : public MgApplicationException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = Common_Exception_MgCoordinateSystemComputationFailedException;
};
