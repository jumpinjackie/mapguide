...
///
class MG_SERVICE_API MgDuplicateParameterException : public MgApplicationException
{
...
CLASS_ID:
    ...
    static const INT32 m_cls_id = Common_Exception_MgDuplicateParameterException;
};
