...
template class MG_SERVICE_API Ptr<MgGeometryProperty>;
...
///
class MG_SERVICE_API MgGeometryProperty : public MgNullableProperty
{
...
CLASS_ID:
    static const INT32 m_cls_id = CoreData_Property_GeometryProperty;
};
/// \}
