...
class MG_SERVICE_API MgMappingService : public MgService
{
PUBLISHED_API:
    ////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief
...
INTERNAL_API:
    ...
    ///
    MgMappingService(MgConnectionProperties* connection);
...
CLASS_ID:
    static const INT32 m_cls_id = MappingService_MappingService;
