...
template class MG_SERVICE_API Ptr<MgResourceIdentifier>;
...
class MG_SERVICE_API MgResourceIdentifier : public MgSerializable
{
...
CLASS_ID:
    static const INT32 m_cls_id = ResourceService_ResourceIdentifier;
};
/// \}
