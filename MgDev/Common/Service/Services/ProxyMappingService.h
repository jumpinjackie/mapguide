...
/// \defgroup MgProxyMappingService MgProxyMappingService
...
/// MapGuide.
class MG_SERVICE_API MgProxyMappingService : public MgMappingService
{
...
INTERNAL_API:
    ...
    ///
    MgProxyMappingService(MgConnectionProperties* connection);
