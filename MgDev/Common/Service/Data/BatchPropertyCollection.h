...
template class MG_SERVICE_API Ptr<MgBatchPropertyCollection>;
...
class MG_SERVICE_API MgBatchPropertyCollection : public MgCollection
{
...
PUBLISHED_API:
    ...
    /// \exception MgDuplicateObjectException if it is duplicate.
    ///
    virtual INT32 Add(MgPropertyCollection* value);
    ...
    /// <!-- Syntax in .Net, Java, and PHP -->
    /// \htmlinclude DotNetSyntaxTop.html
    /// virtual void Remove(MgPropertyCollection value);
    /// \htmlinclude SyntaxBottom.html
    /// \htmlinclude JavaSyntaxTop.html
    /// virtual void Remove(MgPropertyCollection value);
    /// \htmlinclude SyntaxBottom.html
...
CLASS_ID:
    static const INT32 m_cls_id = CoreData_Collection_BatchPropertyCollection;
};
/// \}
