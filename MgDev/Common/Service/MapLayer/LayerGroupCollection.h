...
template class MG_SERVICE_API Ptr<MgLayerGroupCollection>;

////////////////////////////////////////////////////
/// \brief
/// Manipulates collections of MgLayerGroup objects.
///
class MG_SERVICE_API MgLayerGroupCollection : public MgDisposable
{
...
PUBLISHED_API:
    ...
    /// <!-- Syntax in .Net, Java, and PHP -->
    /// \htmlinclude DotNetSyntaxTop.html
    /// void Remove(MgLayerGroup value);
    /// \htmlinclude SyntaxBottom.html
    /// \htmlinclude JavaSyntaxTop.html
    /// void Remove(MgLayerGroup value);
    /// \htmlinclude SyntaxBottom.html
    ...
    /// Returns nothing.
    ///
    /// \exception MgInvalidAgumentException if the layer group does not exist
...
INTERNAL_API:
    ...
    ///
    MgLayerGroupCollection(MgMap* owner);
...
CLASS_ID:
    static const INT32 m_cls_id = MapLayer_LayerGroupCollection;
