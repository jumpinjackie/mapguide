...
/// </summary>
void MgReadOnlyLayerCollection::Add(MgLayer* value)
{
    m_layers->Add(value);
}
...
/// </summary>
MgLayer* MgReadOnlyLayerCollection::GetItem(INT32 index)
{
    MG_TRY()
    return dynamic_cast<MgLayer*>(m_layers->GetItem(index));
...
/// </summary>
bool MgReadOnlyLayerCollection::Contains(MgLayer* value)
{
    MG_TRY()
...
/// </summary>
INT32 MgReadOnlyLayerCollection::IndexOf(MgLayer* value)
{
    MG_TRY()
