...
PUBLISHED_API:
    ...
    /// \htmlinclude SyntaxBottom.html
    ///
    void AddFeatures(MgLayer* layer, MgFeatureReader* features, INT32 nFeatures);
    ...
    /// \htmlinclude SyntaxBottom.html
    ///
    void AddFeatureIds(MgLayer* layer, CREFSTRING className, MgPropertyCollection* identityProperties);
    ...
    /// \htmlinclude SyntaxBottom.html
    ///
    void AddFeatureIdInt16(MgLayer* layer, CREFSTRING className, INT16 identifier);
    ...
    /// \htmlinclude SyntaxBottom.html
    ///
    void AddFeatureIdInt32(MgLayer* layer, CREFSTRING className, INT32 identifier);
    ...
    /// \htmlinclude SyntaxBottom.html
    ///
    void AddFeatureIdInt64(MgLayer* layer, CREFSTRING className, INT64 identifier);
    ...
    /// \htmlinclude SyntaxBottom.html
    ///
    void AddFeatureIdString(MgLayer* layer, CREFSTRING className, CREFSTRING identifier);
    ...
    /// \htmlinclude SyntaxBottom.html
    ///
    bool Contains(MgLayer* layer, CREFSTRING className);
    ...
    /// \htmlinclude SyntaxBottom.html
    ///
    STRING GenerateFilter(MgLayer* layer, CREFSTRING className);
    ...
    /// is the name that was specified when \link MgMap::Create Create \endlink
...
CLASS_ID:
    static const INT32 m_cls_id = MapLayer_Selection;
...
private:
    ...
    SelectionList* GetSelections(MgLayer* layer, CREFSTRING className);
