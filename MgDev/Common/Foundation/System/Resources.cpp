...
const STRING MgResources::ServerServiceName             = L"MapGuideServer2.1"; // Do not translate
const STRING MgResources::ServerServiceDisplayName      = L"MapGuide Server v2.1"; // Do not translate
