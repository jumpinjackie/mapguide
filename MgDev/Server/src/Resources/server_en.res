...
MgLicenseExpiredException                             = License has expired.
...
MgInvalidFromDate                                     = The from date is invalid because it comes before the to date.
...
MgStringContainsReservedCharacters                    = The string cannot contain reserved characters.
