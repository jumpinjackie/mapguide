...
///
class MG_SERVICE_API MgReservedCharacterSet
{
INTERNAL_API:
...
class MG_SERVICE_API MgRepositoryType
{
PUBLISHED_API:
    /// \if INTERNAL   
...
class MG_SERVICE_API MgResourceType
{
PUBLISHED_API:
    ////////////////////////////////////////////////////////////////
    /// \brief
...
///
class MG_SERVICE_API MgResourceTag
{
PUBLISHED_API:
    /// \if INTERNAL   
    /// The "value(xxx)" comments are used by SWIG to build constants.php.  Do not alter them.
...
///
class MG_SERVICE_API MgResourceDataName
{
PUBLISHED_API:
    /////////////////////////////////////////////////////////////////
    /// \brief
...
/// For more information, see the <i>MapGuide Developer's Guide</i>.
///
class MG_SERVICE_API MgResourceDataType
{
PUBLISHED_API:
    /// \if INTERNAL   
    /// The "value(xxx)" comments are used by SWIG to build constants.php.  Do not alter them.
...
///
class MG_SERVICE_API MgResourcePreProcessingType
{
PUBLISHED_API:
    /// \brief
...
///
class MG_SERVICE_API MgResourcePermission
{
PUBLISHED_API:
    /// \if INTERNAL   
    /// The "value(xxx)" comments are used by SWIG to build constants.php.  Do not alter them.
...
/// INTERNAL - Do not document.
///
class MG_SERVICE_API MgResourceFolder
{
INTERNAL_API:
...
/// INTERNAL - Do not document.
///
class MG_SERVICE_API MgResourceHeaderProperties
{
INTERNAL_API:
