dnl $Id: config.m4,v 1.12 2006/11/15 16:53:11 gmf Exp $
...
if test "$PHP_DBXML" != "no"; then
  ...
  PHP_NEW_EXTENSION(dbxml, php_dbxml.cpp php_dbxml_manager.cpp php_dbxml_resolver.cpp php_dbxml_container.cpp php_dbxml_eventreader.cpp php_dbxml_eventwriter.cpp php_dbxml_eventreadertowriter.cpp php_dbxml_exception.cpp php_dbxml_inputstream.cpp php_dbxml_transaction.cpp php_dbxml_results.cpp php_dbxml_value.cpp php_dbxml_queryexpression.cpp php_dbxml_querycontext.cpp php_dbxml_updatecontext.cpp php_dbxml_modify.cpp php_dbxml_indexspecification.cpp php_dbxml_data.cpp php_dbxml_document.cpp php_dbxml_statistics.cpp php_dbxml_indexlookup.cpp, $ext_shared)
