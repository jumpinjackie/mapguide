...
if os.name == 'posix':
    ...
    if not BERKELEYDB_DIR and not BERKELEYDB_LIBDIR and not BERKELEYDB_INCDIR:
        ...
        for x in (0,1,2,3,4,5,):
            db_inc_paths.append('/home/greg/sandbox/BerkeleyDB.4.%d/include' % x)  # XXX GPS
...
\tdependencies in the python executable to libdb as a side effect."""
    ...
    assert ver in ('32', '33', '40', '41', '42', '43', '44'), (
...
setup(name = 'bsddb3',
      version = VERSION,
      description = 'Python interface for BerkeleyDB 3.2 thru 4.4',
      long_description = """\
