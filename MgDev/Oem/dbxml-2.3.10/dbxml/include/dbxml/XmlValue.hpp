...
//
// $Id: XmlValue.hpp,v 1.48 2006/10/30 17:45:48 bostic Exp $
//
...
public:
	...
	/// Return the value as a String, with a non-default encoding.
	std::string asString(const std::string &encoding) const;
	/// Return the value as a Boolean.
	bool asBoolean() const;
	/// Return the value as binary
	XmlData asBinary() const;
	/// Return the value as a Node (change namespace with Xerces version)
	XERCESC::DOMNode *asNode() const;
