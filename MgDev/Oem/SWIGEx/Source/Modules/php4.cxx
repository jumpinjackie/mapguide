...
char cvsroot_php4_cxx[] = "$Header: /cvsroot/SWIG/Source/Modules/php4.cxx,v 1.6 2003/12/17 19:09:17 beazley Exp $";
...
public:
  ...
  void create_extra_files(String *outfile) {
	...
	SWIG_exit(EXIT_FAILURE);
      ...
      Printf(f_extra,
	     "dnl $Id: php4.cxx,v 1.6 2003/12/17 19:09:17 beazley Exp $\n"
	     "dnl ***********************************************************************\n"
