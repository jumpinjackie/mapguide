...
vlogfile_t* new_vlogfile(
	const char * log_file_name,
	void *(*vlogfile_malloc) (size_t),
	void (*vlogfile_free) (void *));

void delete_vlogfile( 
	vlogfile_t* vlogfile); 

void vlogfile_add_line( 
	vlogfile_t* vlogfile, 
	const char * line,
	size_t line_length);

const char * vlogfile_get_line(
	vlogfile_t* vlogfile,
	unsigned long line_number,
	unsigned long * line_length);

void vlogfile_free_line(
	vlogfile_t* vlogfile,
	const char * line);

void vlogfile_clear_log(
	vlogfile_t* v);

FILE * vlogfile_open_snapshot(
	vlogfile_t* v,
	const char * filename);

void vlogfile_dump_snapshot(
	vlogfile_t* v,
	FILE * snapshot_file);

void vlogfile_close_snapshot(
	vlogfile_t* v,
	FILE * snapshot_file);
