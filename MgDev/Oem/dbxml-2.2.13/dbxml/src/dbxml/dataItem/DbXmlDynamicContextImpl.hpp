...
//
// $Id: DbXmlDynamicContextImpl.hpp,v 1.17 2005/11/30 17:12:15 jsnelson Exp $
//
...
{
public:
  DbXmlDynamicContextImpl(QueryContext &qc, Transaction *txn, const XQContext *staticContext, XERCES_CPP_NAMESPACE_QUALIFIER MemoryManager* memMgr);
...
{ DSLthrow(ContextException,X("DbXmlDynamicContextImpl"), X("You cannot change the static context when using a proxying dynamic context")); }
...
{ DSLthrow(ContextException,X("DbXmlDynamicContextImpl"), X("You cannot change the static context when using a proxying dynamic context")); }
inline void DbXmlDynamicContextImpl::setDefaultElementAndTypeNS(const XMLCh* newNS)
{ DSLthrow(ContextException,X("DbXmlDynamicContextImpl"), X("You cannot change the static context when using a proxying dynamic context")); }
...
{ DSLthrow(ContextException,X("DbXmlDynamicContextImpl"), X("You cannot change the static context when using a proxying dynamic context")); }
inline void DbXmlDynamicContextImpl::setConstructionMode(XQStaticContext::ConstructionMode newMode)
{ DSLthrow(ContextException,X("DbXmlDynamicContextImpl"), X("You cannot change the static context when using a proxying dynamic context")); }
inline void DbXmlDynamicContextImpl::setPreserveBoundarySpace(bool value)
{ DSLthrow(ContextException,X("DbXmlDynamicContextImpl"), X("You cannot change the static context when using a proxying dynamic context")); }
inline void DbXmlDynamicContextImpl::setDefaultFLWOROrderingMode(XQStaticContext::FLWOROrderingMode newMode)
{ DSLthrow(ContextException,X("DbXmlDynamicContextImpl"), X("You cannot change the static context when using a proxying dynamic context")); }
...
inline const XMLCh* DbXmlDynamicContextImpl::getDefaultElementAndTypeNS() const { return _staticContext->getDefaultElementAndTypeNS(); }
inline XQStaticContext::FLWOROrderingMode DbXmlDynamicContextImpl::getDefaultFLWOROrderingMode() const { return _staticContext->getDefaultFLWOROrderingMode(); }
...
inline Collation* DbXmlDynamicContextImpl::getCollation(const XMLCh* URI) const { return _staticContext->getCollation(URI); }
inline DataItem* DbXmlDynamicContextImpl::lookUpFunction(const XMLCh* prefix, const XMLCh* name, VectorOfDataItems& v) const { return _staticContext->lookUpFunction(prefix, name, v); }
...
inline XQStaticContext::ConstructionMode DbXmlDynamicContextImpl::getConstructionMode() const { return _staticContext->getConstructionMode(); }
