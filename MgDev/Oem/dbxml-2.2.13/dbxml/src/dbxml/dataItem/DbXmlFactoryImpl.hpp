...
//
// $Id: DbXmlFactoryImpl.hpp,v 1.7 2005/09/08 09:45:42 jsnelson Exp $
//
...
class DbXmlFactoryImpl : public XQFactory
{
public:
	...
	Node::Ptr createNode(const XERCES_CPP_NAMESPACE_QUALIFIER DOMNode *node, Document *doc, const DynamicContext *context) const;
