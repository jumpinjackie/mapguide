...
//
// $Id: ImpliedSchemaNode.cpp,v 1.10 2005/09/06 10:42:06 jsnelson Exp $
//
...
ImpliedSchemaNode::ImpliedSchemaNode(Type type, const DataItem *value, MemoryManager *mm)
	: uri_(0),
	  name_(0),
	  wildcardURI_(false),
	  wildcardName_(false),
...
const DataItem *ImpliedSchemaNode::getValue() const
{
	return value_;
}

void ImpliedSchemaNode::setValue(const DataItem *value)
{
	value_ = value;
}
