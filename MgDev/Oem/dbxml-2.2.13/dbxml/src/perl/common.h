...
#define newSVfromXmlData(data) newSVpvn((char*)data.get_data(), data.get_size())
#define setSVfromXmlData(sv,data) sv_setpvn(sv, (char*)data.get_data(), data.get_size())
#define newSVfromXmlData(data) newSVpvn((char*)data.get_data(), data.get_size())

#define newSVfromXmlValue(value) { std::string str = value.asString(); newSVpvn((char*)str.c_str(), str.length()); }
