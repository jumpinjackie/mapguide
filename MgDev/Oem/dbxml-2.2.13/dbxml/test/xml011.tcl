...
#
# $Id: xml011.tcl,v 1.90 2005/10/13 19:23:01 gmf Exp $
#
# TEST	xml011
...
proc xml011_1_2 { env txnenv cdbenv basename oargs } {
  ...
  dbxml_error_check_good $testid [$context getDefaultCollection] $file_uri
...
proc xml011_6_run { env txnenv basename oargs et rt } {
    ...
    dbxml_error_check_good "$testid - query plan not optimized" [string match "*<OQPlan>*node-element-equality-string*</OQPlan>*" $qp_constant] 1
