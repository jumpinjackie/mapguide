...
//
// $Id: deleteIndex.java,v 1.10 2005/06/21 21:56:12 sarette Exp $
//
...
class deleteIndex
{
    ...
    private static void deleteIndex( XmlManager xmlDB, XmlContainer container,
	...
	throws Throwable {
       ...
       try {
	    ...
	    deleteIndex(theMgr, openedContainer, "", "product",
