...
//
// $Id: addIndex.java,v 1.10 2005/06/21 21:56:12 sarette Exp $
//
...
class addIndex
{
    ...
    private static void addIndex( XmlContainer container, String URI,
				  String nodeName,
	...
	try {
	    ...
	    addIndex( openedContainer, "", "product",
		      "node-element-equality-string", txn, uc );
            //Add an edge presence index for the product node
	    addIndex( openedContainer, "", "product", "edge-element-presence",
		      txn, uc );
