...
class LayerDefinitionFactory
{
    ...
    static function CreateLayerDefinition($resourceId, $featureClass, $geomerty, $featureClassRange)
    {
        $layerDef = file_get_contents("../viewerfiles/layerdefinition.templ");
        $layerDef = sprintf($layerDef, $resourceId, $featureClass, $geomerty, $featureClassRange);
        return $layerDef;
    }
}
