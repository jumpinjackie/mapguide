...
const wchar_t* IDS_STRING_eGwsFailedToFetchResults                      = L"Failed to featch query results.";
...
const wchar_t* IDS_STRING_eGwsFailedToFlushChanges                      = L"Failed to flush changed to the feature source or cache.";
